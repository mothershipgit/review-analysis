...
def xray_window_seasonality_index(seasonality):
    ...
    Walks each of the 30 days in the window (ending on XRAY_EXPORT_DATE),
    ...
    Auto-aligns to whichever month(s) the X-Ray actually covers — no need to
    edit this function when the export date changes."""
    if not seasonality:
        return 1.0
    ...
    days_counted = 0
    for i in range(30):
        d = XRAY_EXPORT_DATE - timedelta(days=i)
